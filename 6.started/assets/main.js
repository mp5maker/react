...
(function () {
  ...
  ReactDOM.render(React.createElement(_table.Table, null), document.getElementById('some-data'));
})();
"use strict";
...
(function () {
  ...
  function (_React$Component) {
    ...
    _createClass(Table, [{
      key: "render",
      value: function render() {
        return React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Name"), React.createElement("th", null, "Job"))), React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, "Charlie"), React.createElement("td", null, "Janitor")), React.createElement("tr", null, React.createElement("td", null, "Mac"), React.createElement("td", null, "Bouncer")), React.createElement("tr", null, React.createElement("td", null, "Dee"), React.createElement("td", null, "Aspiring actress")), React.createElement("tr", null, React.createElement("td", null, "Dennis"), React.createElement("td", null, "Bartender"))));
      }
    }]);
